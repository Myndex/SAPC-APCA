////////////////////////////////////////////////////////////////////////////////
/** @preserve
/////           BPCA - BRIDGE PCA - Beta Algorithm 0.98g
...
var SAPCparams = { sDark: 0,sMid: 0,sLight: 0,sAltMid: 0,sAdapt: 0,
				...
				Rco: 0.2126478133913640, //0.2126,
				Gco: 0.7151791475336150, //0.7152,
				Bco: 0.0721730390750208, //0.0722,
...
///// Primary Constants /////
	...
	//  Lint Traps & misc
			...
			let bridgeWoBfact = 0.1414;
			let bridgeWoBpivot = 0.84;
...
//////////   BLACK SOFT CLAMP MODULE    ////////////////////////////////////
	...
	if(Math.abs(bgY - txtY) < deltaYmin){ return (places == -1) ? 0.0 : "Y∆LOW";}

//////////   SAPC CONTRAST MODULE       ////////////////////////////////////

    if ( bgY > txtY ) { 	// For normal polarity, black text on white
